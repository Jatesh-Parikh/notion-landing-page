...
export default function ContactForm() {
  ...
  return (
    <main className="md:flex md:space-x-4 justify-center py-20 px-8 border-b h-full w-full relative overflow-hidden">
      <section>
        ...
        {!submitted ? (
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="text-xs font-light mt-1 md:w-3/4 mb-1">
                I agree to Bird&apos;s sending information about updates,
                events, meetups, and more.
              </div>
            </div>
