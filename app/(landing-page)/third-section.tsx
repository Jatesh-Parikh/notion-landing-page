...
const ThirdSection = () => {
  return (
    <section className="xl:pt-32 pt-24 relative flex justify-center items-center flex-col">
      <div className="xl:text-5xl text-3xl 2xl:w-3/5 xl:w-1/3 w-3/5 font-medium mx-auto text-center">
      ...
      <div
        className={cn(
          "text-xl xl:text-2xl pt-10 pb-4 xl:py-10 px-8 text-center w-4/5",
          font.className
        )}
      >
