...
const SixthSection = () => {
  ...
  return (
    <section className="pt-20 xl:pt-24 flex justify-center items-center flex-col">
      ...
      <div className="grid grid-cols-12 gap-4 xl:gap-6 mt-8 px-8 md:px-16 xl:px-0 md:w-full xl:w-3/4 2xl:w-[55%] mx-auto">
        {tabs.map((tab, index) => (
          <div
            key={index}
            className={`col-span-12
              ${
                index <= 2
                  ...
                  : index === 5
                  ? "md:col-span-6 lg:col-span-8 lg:row-span-3 bg-[#f6f5f4] p-6 rounded-xl flex justify-center"
                  : index > 5
                  ? "md:col-span-4 bg-[#f6f5f4] p-6 rounded-xl flex-col"
                  : ""
              }`}
          >
            {index <= 2 ? (
              ...
              <>
                {tab.images && (
                  <div className="flex justify-center items-center flex-col">
                    ...
                    <div className="flex space-x-2 lg:space-x-5 xl:mt-10">
                      {tab.images.map((_, index) => (
                        <div
                          key={index}
                          onClick={() => handleDotClick(index)}
                          className={`${
                            index === activeImageIndex
                              ? "p-1 rounded-full bg-green-400 w-3 h-3"
                              : "p-1 rounded-full bg-blue-400 w-3 h-3"
                          }`}
                        ></div>
                      ))}
                    </div>
              ...
              index > 5 && (
                <>
                  ...
                  <div className="text-sm font-normal mt-6 md:mt-0 pb-2">
                    {tab.userText}
                  </div>
                </>
              )
