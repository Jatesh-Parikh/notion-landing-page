...
const FourthSection = () => {
  ...
  return (
    <section className="flex flex-col pt-20 xl:py-32 items-center justify-center">
      <div className="text-3xl xl:text-5xl font-medium justify-center items-center flex">
        Powerful building blocks
      </div>
      <div className="grid md:grid-cols-2 gap-4 xl:gap-6 mt-8 px-8 md:px-16 xl:px-0 xl:w-3/4 2xl:w-[55%] md:w-full mx-auto">
        {tabs.map((tab, index) => (
          <div
            key={index}
            className={`${
              index === 0 ? "md:col-span-2" : "md:col-span-1"
            } bg-[#f6f5f4] p-6 rounded-xl flex flex-col`}
          >
            {tab.icon}
            ...
            {index === 0 && tab.images && (
              <div>
                ...
                <div className="flex items justify-center gap-2 lg:gap-4 xl:w-1/2 xl:space-x-2 mx-auto">
                    ...
                    <span
                      ...
                      className={`${
                        index === activeImageIndex
                          ? "rounded-md bg-[#dbd9d9]"
                          : "rounded-md bg-[#f6f5f4] hover:bg-[#dbd9d9] "
                      } text-sm py-1 px-4`}
                    >
                      {image.title}
                    </span>
      ...
      <div
        className={cn(
          "text-xl xl:text-2xl xl:py-10 pt-6 px-8 md:px-8 md:w-2/3 xl:w-1/2 text-center",
          font.className
        )}
      >
        &quot;Bird adapts to your needs. It&apos;s as minimal or as powerful as
        you need it to be.&quot;
      </div>
      ...
      <Image
        ...
        width={1000}
        height={1000}
        className="pt-2 xl:pt-0 w-8 xl:w-14 "
      />

      <div className="text-center">
        <div className="text-sm font-medium pt-4">Eric Woods</div>
        <div className="text-sm">VP of Engineering, Palium Software</div>
      </div>
    </section>
  );
};
